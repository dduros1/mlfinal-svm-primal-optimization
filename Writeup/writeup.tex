...
Our optimizers return the coefficients of the hyperplane that maximizes the margin, where we have as many coefficients as we do features.
...
We can write \eqref{primalobj} as an unconstrained optimization function.
